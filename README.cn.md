...
合计: **26,068** 行代码（覆盖前 5 种语言、共 **165** 个文件）。
...
- **上游仓库**: <https://github.com/reviewdog/reviewdog>
- **官网**: <https://medium.com/@haya14busa/reviewdog-a-code-review-dog-who-keeps-your-codebase-healthy-d957c471938b#.8xctbaw5u>
- **许可证**: MIT

## 发布

- **最新版本**: `v0.21.0` (2025-09-03)
- **最近提交**: 2026-09-11
- **Release 含资产**: 11 个

## 流行度

- **Star**: 9,581 · **Fork**: 492 · **开放 issue**: 327 · **贡献者**: 155

## 累计统计

- **发布数**: 44 · **已合并 PR**: 2237 · **开放 PR**: 13 · **已关闭 issue**: 199 · **开放 issue**: 128 · **提交数**: 5712

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-12 | 0 | 60 | 5 | 1 | 1 | 62 |
| last60d | 2026-07-13 | 0 | 101 | 6 | 1 | 1 | 104 |
| 90d | 2026-06-13 | 0 | 135 | 7 | 1 | 1 | 146 |
| last180d | 2026-03-15 | 0 | 272 | 8 | 1 | 4 | 285 |
| 360d | 2025-09-16 | 0 | 480 | 9 | 2 | 6 | 495 |
| last720d | 2024-09-21 | 2 | 755 | 12 | 12 | 21 | 1591 |
...
在 [repology.org](https://repology.org/project/reviewdog) 上共有 **9** 个发行版报告此项目。**6** 个 ✅ 已是最新上游版本，**3** 个 ⚠️ 使用旧版本。
...
reviewdog 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `reviewdog` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/reviewdog.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260911.yml` · 2026-09-11T19:17:48Z._
